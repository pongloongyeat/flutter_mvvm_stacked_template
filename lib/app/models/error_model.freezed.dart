...
abstract class $ErrorModelCopyWith<$Res> {
  ...
  $Res call(
      {int? errorCode, String? errorMessage, String? errorCodeDescription});
}
...
class _$_ErrorModel extends _ErrorModel {
  _$_ErrorModel({this.errorCode, this.errorMessage, this.errorCodeDescription})
      : super._();
  ...
  @override
  String toString() {
    return 'ErrorModel(errorCode: $errorCode, errorMessage: $errorMessage, errorCodeDescription: $errorCodeDescription)';
  }
...
abstract class _ErrorModel extends ErrorModel {
  factory _ErrorModel(
      {final int? errorCode,
      final String? errorMessage,
      final String? errorCodeDescription}) = _$_ErrorModel;
